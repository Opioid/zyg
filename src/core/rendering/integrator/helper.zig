...
pub inline fn russianRoulette(throughput: *Vec4f, path_count: u32, r: f32) bool {
    const continuation_probability = math.maxComponent3(throughput.*) * @intToFloat(f32, path_count);
