...
pub const Integrator = struct {
    ...
    fn integrateHomogeneousSSS(prop: u32, trafo: Trafo, vertex: *Vertex, frag: *Fragment, sampler: *Sampler, context: Context) void {
        ...
        const current_time_start = context.scene.current_time_start;
        ...
        for (0..256) |_| {
            ...
            if (!shape.intersect(vertex.probe, trafo, current_time_start, &frag.isec)) {
                ...
                shape.fragment(vertex.probe, current_time_start, frag);
