...
pub const Mul = struct {
    ...
    pub fn evaluate1(self: Mul, rs: Renderstate, key: ts.Key, sampler: *Sampler, scene: *const Scene) f32 {
    ...
    pub fn evaluate2(self: Mul, rs: Renderstate, key: ts.Key, sampler: *Sampler, scene: *const Scene) Vec2f {
    ...
    pub fn evaluate3(self: Mul, rs: Renderstate, key: ts.Key, sampler: *Sampler, scene: *const Scene) Vec4f {
