    ...
    switch (texture.type) {
        ...
        .Procedural => return context.sampleProcedural2D_1(texture, rs, sampler),
            ...
            return switch (texture.mode.filter) {
                ...
                .LinearStochastic => LinearStochastic2D.sampleMip_1(texture, st, rs, rs.stochastic_r, context),
            };
        },
    }
}
    ...
    switch (texture.type) {
        ...
        .Procedural => return context.sampleProcedural2D_2(texture, rs, sampler),
            ...
            return switch (texture.mode.filter) {
                ...
                .LinearStochastic => LinearStochastic2D.sampleMip_2(texture, st, rs, rs.stochastic_r, context),
            };
        },
    }
}
    ...
    switch (texture.type) {
        ...
        .Procedural => return context.sampleProcedural2D_3(texture, rs, sampler),
            ...
            return switch (texture.mode.filter) {
                ...
                .LinearStochastic => LinearStochastic2D.sampleMip_3(texture, st, rs, rs.stochastic_r, context),
            };
        },
    }
}
