...
pub const MotionData = struct {
    ...
    pub fn positionAt(self: Self, index: u32, time: u64, current_time_start: u64) Vec4f {
        const i = (time - current_time_start) / FrameDuration;
        const a_time = current_time_start + i * FrameDuration;
