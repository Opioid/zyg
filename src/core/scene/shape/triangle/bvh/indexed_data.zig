...
pub const Indexed_data = struct {
    ...
    pub inline fn intersect(self: *const Self, ray: Ray, index: usize) ?triangle.Intersection {
    ...
    pub inline fn intersectP(self: *const Self, ray: Ray, index: usize) bool {
        const tri = self.triangles[index];
    ...
    pub inline fn interpolateP(self: *const Self, u: f32, v: f32, index: u32) Vec4f {
        const tri = self.triangles[index];
    ...
    pub inline fn interpolateData(self: *const Self, u: f32, v: f32, index: u32, t: *Vec4f, n: *Vec4f, uv: *Vec2f) void {
        const tri = self.triangles[index];
    ...
    pub inline fn interpolateShadingNormal(self: *const Self, u: f32, v: f32, index: u32) Vec4f {
        const tri = self.triangles[index];
    ...
    pub inline fn interpolateUv(self: *const Self, u: f32, v: f32, index: u32) Vec2f {
        const tri = self.triangles[index];
    ...
    pub inline fn part(self: *const Self, index: u32) u32 {
        return self.triangles[index].part;
    }

    pub inline fn normal(self: *const Self, index: u32) Vec4f {
        const tri = self.triangles[index];
    ...
    pub inline fn bitangentSign(self: *const Self, index: u32) f32 {
    ...
    pub inline fn sample(self: *const Self, index: u32, r2: Vec2f, p: *Vec4f, tc: *Vec2f) void {
