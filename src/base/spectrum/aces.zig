...
pub fn sRGBtoAP1(srgb: Vec4f) Vec4f {
    return Vec4f.init3(
        0.61309732 * srgb.v[0] + 0.33952285 * srgb.v[1] + 0.04737928 * srgb.v[2],
...
pub fn AP1tosRGB(srgb: Vec4f) Vec4f {
    return Vec4f.init3(
        1.70505155 * srgb.v[0] - 0.62179068 * srgb.v[1] - 0.08325840 * srgb.v[2],
...
pub fn AP1toRRT_SAT(acescg: Vec4f) Vec4f {
    return Vec4f.init3(
        0.970889 * acescg.v[0] + 0.026963 * acescg.v[1] + 0.002148 * acescg.v[2],
...
pub fn sRGBtoRRT_SAT(srgb: Vec4f) Vec4f {
    return Vec4f.init3(
        0.59719 * srgb.v[0] + 0.35458 * srgb.v[1] + 0.04823 * srgb.v[2],
...
pub fn ODTSATtosRGB(odt: Vec4f) Vec4f {
    return Vec4f.init3(
        1.60475 * odt.v[0] - 0.53108 * odt.v[1] - 0.07367 * odt.v[2],
...
pub fn XYZtoAP1(xyz: Vec4f) Vec4f {
    return Vec4f.init3(
        1.66058533 * xyz.v[0] - 0.31529556 * xyz.v[1] - 0.24150933 * xyz.v[2],
