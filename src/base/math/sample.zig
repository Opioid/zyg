...
pub fn disk_concentric(uv: Vec2f) Vec2f {
...
pub fn oriented_hemisphere_cosine(uv: Vec2f, x: Vec4f, y: Vec4f, z: Vec4f) Vec4f {
    const xy = disk_concentric(uv);
